...
class FashionClassifier : public Classifier 
{
public:
    FashionClassifier(const std::string& modelpath,
                 const int width,
                 const int height);

    FashionClassifier(const FashionClassifier&) = delete;

    FashionClassifier& operator=(const FashionClassifier&) = delete;
