...
using fashion::FashionClassifier;

void FashionClassifier::delete_tf_session(TF_Session *tf_session) 
{
...
FashionClassifier::FashionClassifier(const std::string& modelpath,
                           const int width,
                           const int height)
    : width_{width}
    , height_{height} 
...
size_t FashionClassifier::num_classes() const 
{
    return 10;
}

size_t FashionClassifier::predict(const features_t& feat) const 
{
...
FashionClassifier::probas_t FashionClassifier::predict_proba(const features_t& feat) const 
{
